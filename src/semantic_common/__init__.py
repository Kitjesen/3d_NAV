"""Compatibility wrapper for the top-level ``semantic_common`` package."""

from importlib import import_module
from pathlib import Path

_IMPL_PACKAGE = "semantic.common.semantic_common"
_IMPL_DIR = Path(__file__).resolve().parent.parent / "semantic" / "common" / "semantic_common"
