...
\midrule
\textbf{NaviMind (Ours)} & \TBD{--} & \TBD{--} & \TBD{--} & \TBD{--} \\
\bottomrule
\end{tabular}
\vspace{-2mm}
\end{table}

Table~\ref{tab:hm3d_main} compares NaviMind against state-of-the-art zero-shot methods on HM3D ObjectNav.
\TBD{Fill with HM3D evaluation results from experiments/habitat\_eval/.}
...
\midrule
Chair       & \TBD{--} & \TBD{--} & \TBD{--} & \TBD{--} \\
Couch       & \TBD{--} & \TBD{--} & \TBD{--} & \TBD{--} \\
Bed         & \TBD{--} & \TBD{--} & \TBD{--} & \TBD{--} \\
Toilet      & \TBD{--} & \TBD{--} & \TBD{--} & \TBD{--} \\
Potted Plant& \TBD{--} & \TBD{--} & \TBD{--} & \TBD{--} \\
TV/Monitor  & \TBD{--} & \TBD{--} & \TBD{--} & \TBD{--} \\
\midrule
\textbf{Average} & \TBD{--} & \TBD{--} & \TBD{--} & \TBD{--} \\
\bottomrule
\end{tabular}
\vspace{-2mm}
\end{table}
...
\midrule
\textbf{Full NaviMind}    & \TBD{--} & \TBD{--} & \TBD{--} & -- \\
w/o BA-HSG Belief         & \TBD{--} & \TBD{--} & \TBD{--} & \TBD{--} \\
w/o FOV-aware update      & \TBD{--} & \TBD{--} & \TBD{--} & \TBD{--} \\
w/o Hierarchy (flat SG)   & \TBD{--} & \TBD{--} & \TBD{--} & \TBD{--} \\
Always LLM (no Fast Path) & \TBD{--} & \TBD{--} & \TBD{--} & \TBD{--} \\
\bottomrule
\end{tabular}
\vspace{-2mm}
\end{table}

\TBD{Fill Tables~\ref{tab:hm3d_main},~\ref{tab:hm3d_per_category},~\ref{tab:ablation} after running: bash experiments/habitat\_eval/run\_ablation.sh}
