# -*- coding: utf-8 -*-
"""
NaviMind LingTu -- Investment pitch deck PPT generator v2

Redesigned from scratch:
  - Investor Pitch Deck structure (22 slides)
  - Gradient background + modern design language
  - In-depth knowledge points per slide
  - Market / tech moat / business model / competitor analysis
"""
...
# Color palette -- deep space blue + electric blue + white
C_BG1       = RGBColor(0x0B, 0x0E, 0x1A)   # darkest background
C_BG2       = RGBColor(0x11, 0x16, 0x2B)   # card background
C_BG3       = RGBColor(0x1A, 0x20, 0x3C)   # light card
C_ACCENT    = RGBColor(0x00, 0xB4, 0xD8)   # primary blue
C_ACCENT_L  = RGBColor(0x48, 0xCA, 0xE4)   # light blue
C_GREEN     = RGBColor(0x06, 0xD6, 0xA0)   # success green
C_ORANGE    = RGBColor(0xFF, 0xA6, 0x2B)   # warning orange
C_RED       = RGBColor(0xEF, 0x47, 0x6F)   # emphasis red
C_PURPLE    = RGBColor(0xA7, 0x7B, 0xFF)   # purple
C_GOLD      = RGBColor(0xFF, 0xD6, 0x6B)   # gold
